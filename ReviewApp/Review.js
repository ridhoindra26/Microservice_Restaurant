...
const reviews = [
    ...
    {user_id:3, restaurant_id:3, review:"Dari luar, tempatnya sangat estetik"},
    {user_id:4, restaurant_id:2, review:"Agak kecil tempatnya, tapi makannya murah dan lumayan enak"}
]
...
app.get('/review/:restaurant_id', (req, res) => {
